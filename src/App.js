        ...
        <div className='container-fluid'>
          <div className="row">
            ...
            <div className='form-background'>
              ...
              <div className='fullnamecontainer col-10'><input type="text" placeholder='Enter Email…' className='fullnameinput form-control'/></div>
              </div>
              <div style={{display:'flex',flexWrap:'wrap',flexDirection:'row'}}>  
              <div><img src={otp} className='otpimg' /></div>
              <div className='OTPContainer'>
                <div style={{width:'50px',margin:'0 5px'}}><input type="text" placeholder='0' className='OTP-Input form-control'/></div>
                <div style={{width:'50px',margin:'0 5px'}}><input type="text" placeholder='0' className='OTP-Input form-control'/></div>
                <div style={{width:'50px',margin:'0 5px'}}><input type="text" placeholder='0' className='OTP-Input form-control'/></div>
                <div style={{width:'50px',margin:'0 5px'}}><input type="text" placeholder='0' className='OTP-Input form-control'/></div>
                <div style={{width:'50px',margin:'0 5px'}}><input type="text" placeholder='0' className='OTP-Input form-control'/></div>
              ...
              <div style={{display:'flex',flexWrap:'wrap',flexDirection:'row',justifyContent:'space-around',marginBottom:'30px'}}>  
              <div><input type='radio' name='account-type' /><span className='label-radiobtn'>Working Professional</span></div>
              <div><input type='radio' name='account-type' /><span className='label-radiobtn'>Student</span></div>
              </div>
